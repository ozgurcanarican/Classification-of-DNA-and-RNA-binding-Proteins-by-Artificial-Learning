...
#**********************************************************************************************
# RANDOM FOREST MODELİNİN OLUŞTURULMASI
...
grs = GridSearchCV(RandomForestClassifier(), param_grid = grid, cv = 10)
...
initial_results_fname = "pipeline1_rf_results(initial).txt"
six_k_results_fname = "pipeline2_rf_results(selected_6000).txt"
four_k_results_fname = "pipeline3_rf_results(selected_4000).txt"
two_k_results_fname = "pipeline4_rf_results(selected_2000).txt"
one_k_results_fname = "pipeline5_rf_results(selected_1000).txt"
five_h_results_fname = "pipeline6_rf_results(selected_500).txt"

initial_results_header = "PIPELINE-1 RF RESULTS"
six_k_results_header = "PIPELINE-2 RF RESULTS"
four_k_results_header = "PIPELINE-3 RF RESULTS"
two_k_results_header = "PIPELINE-4 RF RESULTS"
one_k_results_header = "PIPELINE-5 RF RESULTS"
five_h_results_header = "PIPELINE-6 RF RESULTS"
...
initial_title = "ROC Curves for Random Forest Classifier (Max Data Complexity)"
six_k_title = "ROC Curves for Random Forest Classifier (6000 Features Selected)"
four_k_title = "ROC Curves for Random Forest Classifier (4000 Features Selected)"
two_k_title = "ROC Curves for Random Forest Classifier (2000 Features Selected)"
one_k_title = "ROC Curves for Random Forest Classifier (500 Features Selected)"
five_h_title = "ROC Curves for Random Forest Classifier (Min Data Complexity)"
...
initial_roc_fname = "pipeline1_rf_ROC(initial).png"
six_k_roc_fname = "pipeline2_rf_ROC(selected_6000).png"
four_k_roc_fname = "pipeline3_rf_ROC(selected_4000).png"
two_k_roc_fname = "pipeline4_rf_ROC(selected_2000).png"
one_k_roc_fname = "pipeline5_rf_ROC(selected_1000).png"
five_h_roc_fname = "pipeline6_rf_ROC(selected_500).png"
...
initial_model = "pipeline1_rf(initial)"
six_k_model = "pipeline2_rf(selected_6000)"
four_k_model = "pipeline3_rf(selected_4000)"
two_k_model = "pipeline4_rf(selected_2000)"
one_k_model = "pipeline5_rf(selected_1000)"
five_h_model = "pipeline6_rf(selected_500)"
